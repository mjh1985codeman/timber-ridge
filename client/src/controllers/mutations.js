...
mutation Mutation($name: String, $reserved: Boolean, $reserveCost: Money, $addressSt: String, $city: String, $state: String, $zip: String, $readyToReserve: Boolean, $available: Boolean) {
